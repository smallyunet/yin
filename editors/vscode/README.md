...
The extension includes the Yin 0.14.0 language server and communicates with it
...
Yin 0.14.0 provides diagnostics and formatting. Hover, completion, and go to
