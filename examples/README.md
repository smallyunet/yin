...
| `agents/` | `structured-agent.yin`, `typed-tool.yin`, `agent-review/`, `capability-decision/`, `tool-boundary/`, `action-gateway/` | Ordered typed policy, deterministic decisions, guarded tools, real MCP stdio actions, and JSON workflows |
